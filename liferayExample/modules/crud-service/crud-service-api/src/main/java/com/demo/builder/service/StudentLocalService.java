...
public interface StudentLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.demo.builder.service.impl.StudentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the student local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link StudentLocalServiceUtil} if injection and service tracking are not available.
	 */
	public void addStudent(
		String stuName, String stuAddress, int stuAge, Date stuJoinDate,
		long stuPhoneNo);
	...
	public Student createStudent(long stuId);
	...
	public Student deleteStudent(long stuId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Student fetchStudent(long stuId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Student getStudent(long stuId) throws PortalException;
