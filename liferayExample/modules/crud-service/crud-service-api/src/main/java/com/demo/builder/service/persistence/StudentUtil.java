...
package com.demo.builder.service.persistence;
...
public class StudentUtil {
	...
	public static Student findByUuid_First(
		...
		throws com.demo.builder.exception.NoSuchStudentException {
	 ...
	 */
	public static Student create(long stuId) {
		return getPersistence().create(stuId);
	}
	 ...
	 * @throws NoSuchStudentException if a student with the primary key could not be found
	 */
	public static Student remove(long stuId)
		throws com.demo.builder.exception.NoSuchStudentException {

		return getPersistence().remove(stuId);
	}
	 ...
	 * @throws NoSuchStudentException if a student with the primary key could not be found
	 */
	public static Student findByPrimaryKey(long stuId)
		throws com.demo.builder.exception.NoSuchStudentException {

		return getPersistence().findByPrimaryKey(stuId);
	}
	 ...
	 */
	public static Student fetchByPrimaryKey(long stuId) {
		return getPersistence().fetchByPrimaryKey(stuId);
	}
