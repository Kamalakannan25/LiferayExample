 ...
 * <code>com.demo.builder.service.impl.StudentLocalServiceImpl</code> and
...
public class StudentLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.demo.builder.service.impl.StudentLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Student createStudent(long stuId) {
		return getService().createStudent(stuId);
	}
	 ...
	 */
	public static Student deleteStudent(long stuId) throws PortalException {
		return getService().deleteStudent(stuId);
	}
	...
	public static Student fetchStudent(long stuId) {
		return getService().fetchStudent(stuId);
	}
	 ...
	 * @throws PortalException if a student with the primary key could not be found
	 */
	public static Student getStudent(long stuId) throws PortalException {
		return getService().getStudent(stuId);
	}
