...
import com.demo.builder.exception.NoSuchStudentException;
...
import com.demo.builder.service.persistence.StudentPersistence;
import com.demo.builder.service.persistence.StudentUtil;
import com.demo.builder.service.persistence.impl.constants.BUILDPersistenceConstants;
...
public class StudentPersistenceImpl
	 ...
	 *
	 * @param stuId the primary key of the current student
	 * @param uuid the uuid
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public Student[] findByUuid_PrevAndNext(
			long stuId, String uuid,
			OrderByComparator<Student> orderByComparator)
		throws NoSuchStudentException {

		uuid = Objects.toString(uuid, "");

		Student student = findByPrimaryKey(stuId);
	 ...
	 */
	@Override
	public Student create(long stuId) {
		Student student = new StudentImpl();

		student.setNew(true);
		student.setPrimaryKey(stuId);
	 ...
	 */
	@Override
	public Student remove(long stuId) throws NoSuchStudentException {
		return remove((Serializable)stuId);
	}
	 ...
	 */
	@Override
	public Student findByPrimaryKey(long stuId) throws NoSuchStudentException {
		return findByPrimaryKey((Serializable)stuId);
	}
	 ...
	 */
	@Override
	public Student fetchByPrimaryKey(long stuId) {
		return fetchByPrimaryKey((Serializable)stuId);
	}
	...
	@Override
	@Reference(
		target = BUILDPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = BUILDPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
